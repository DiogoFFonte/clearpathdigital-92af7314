...
const CTA = () => {
  return <section className="py-20 lg:py-32 bg-secondary relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="bg-white text-secondary hover:bg-white/90 font-semibold px-8 py-4 text-lg group transform hover:scale-105 transition-all duration-300 shadow-lg">
              <Calendar className="mr-2 w-5 h-5" />
              Agende uma Consultoria Gratuita
              <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Button>
            
            <Button variant="outline" size="lg" className="border-2 border-white text-white hover:bg-white hover:text-secondary font-semibold px-8 py-4 text-lg transition-all duration-300">
          ...
          {/* Trust Indicator */}
          <p className="text-sm text-white/70 mt-8">Resposta em menos de 24 horas • Consultoria sem custo </p>
        </div>
      </div>
    </section>;
};
